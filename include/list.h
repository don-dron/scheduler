...
static void list_push_back(list *lst, list_node *node)
{
...
static void list_push_front(list *lst, list_node *node)
{
    lock_spinlock(&lst->lock);
    if (lst->size == 0)
    {
...
static list_node *list_pop_back(list *lst)
{
    lock_spinlock(&lst->lock);
    if (lst->size == 0)
    {
...
static list_node *list_pop_front(list *lst)
{
    lock_spinlock(&lst->lock);
    if (lst->size == 0)
    {
